...
# ключевые слова пишутся без «ё»: normalize() заменяет её на «е» в тексте пациента,
# поэтому «отёк» в словаре не совпал бы никогда
SPECIALIZATION_KEYWORDS = {
    ...
    "хирург": ["хирург", "операц", "аппендиц", "нарыв", "абсцесс", "фурункул"],
    "пульмонолог": ["одышк", "бронхит", "астм", "хрип"],
    "аллерголог": ["аллерг", "крапивниц", "поллиноз"],
    "ревматолог": ["артрит", "артроз", "подагр", "ревмат", "скован"],
    "онколог": ["онколог", "опухол", "новообразован", "узел"],
    "инфекционист": ["инфекц", "гепатит", "паразит", "глист"],
    "стоматолог": ["зуб", "десн"],
    "педиатр": ["ребенок", "ребенка", "детск", "младенц", "грудничок"],
    "психотерапевт": ["тревог", "депресс", "панич", "стресс"],
}
...
SPECIALIZATION_KEYWORDS_TG = {
    ...
    "травматолог": ["шикастан", "буғум", "зону", "лат хӯрд", "китф", "оринҷ", "афтидам"],
    "хирург": ["ҷарроҳ", "амалиёт"],
    "пульмонолог": ["нафастангӣ", "бронхит"],
    "аллерголог": ["аллергия"],
    "ревматолог": ["артрит", "ревматизм"],
    "онколог": ["варам"],
    "инфекционист": ["сироят", "гепатит"],
...
SPECIALIZATION_KEYWORDS_EN = {
    ...
    "хирург": ["surgeon", "surgery", "appendic", "abscess"],
    "пульмонолог": ["shortness of breath", "asthma", "bronchitis", "wheez"],
    "аллерголог": ["allerg", "hives"],
    "ревматолог": ["arthritis", "gout", "rheumat"],
    "онколог": ["oncolog", "tumor", "lump"],
    "инфекционист": ["hepatitis", "parasite"],
...
SPECIALIST_HIERARCHY = {
    ...
    "невролог": ["терапевт", "травматолог", "хирург"],
    "терапевт": ["кардиолог", "невролог"],
    "отоларинголог": ["терапевт"],
    "офтальмолог": ["терапевт"],
    "дерматолог": ["аллерголог", "терапевт"],
    "гастроэнтеролог": ["терапевт"],
    "эндокринолог": ["терапевт"],
    "уролог": ["нефролог", "терапевт"],
    "нефролог": ["уролог", "терапевт"],
    "гинеколог": ["акушер", "терапевт"],
    "акушер": ["гинеколог", "терапевт"],
    "травматолог": ["хирург", "терапевт"],
    "хирург": ["травматолог", "терапевт"],
    "пульмонолог": ["терапевт"],
    "аллерголог": ["дерматолог", "терапевт"],
    "ревматолог": ["травматолог", "терапевт"],
    "онколог": ["терапевт"],
    "инфекционист": ["терапевт"],
    "стоматолог": ["хирург", "терапевт"],
    "педиатр": ["терапевт"],
    "психотерапевт": ["невролог", "терапевт"],
}
